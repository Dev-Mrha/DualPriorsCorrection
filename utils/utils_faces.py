...
def get_reference_facial_points(output_size=None,
    ...
    if size_bf_outer_pad[0] * tmp_crop_size[1] != size_bf_outer_pad[1] * tmp_crop_size[0]:
        print(size_bf_outer_pad, tmp_crop_size)
...
def warp_and_crop_face(src_img,
    ...
    if align_type == 'cv2_affine':
        ...
        # params, _ = _umeyama(ref_pts, src_pts, False, scale=scale)
        tfm_inv = params[:2, :]
...
def color_parse_map(tensor, size=None):
    ...
    """
    MASK_COLORMAP = [[0, 0, 0], [204, 0, 0], [76, 153, 0], [204, 204, 0], [51, 51, 255], [204, 0, 204], [0, 255, 255],
...
def head_parse_map(tensor, size=None):
    """
    input: tensor or batch tensor
    return: binary head
    """
    MASK_Head = [[0], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255],
                 [255], [0], [0], [0]]
    # MASK_Head = [[0], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [255], [0], [0], [255], [0], [0], [0]]
    ...
    for t in tensor:
        ...
        for idx, color in enumerate(MASK_Head):
            tmp_img[t == idx] = color
        if size is not None:
            tmp_img = cv2.resize(tmp_img, (size, size))
        tmp_img = tmp_img / 255
        mask_maps.append(tmp_img.astype(np.float32))
    return mask_maps
